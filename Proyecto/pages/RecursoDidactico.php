                            ...
                            <section id="wizard">
                                ...
                                <div id="pills">
                                    <ul>
                                        ...
                                        <li><a href="#tabi5" data-toggle="tab">Guardar</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane well" style="background-color: #ffffff" id="tabi5">
                                            ...
                                            <div class="panel panel-info" id="contenido">
                                                <div class="panel-heading text-center">
                                                    ...
                                                    <ul class="list-unstyled" style="width: 75%; margin-left: 10% ;text-align: justify">
                                                        <ol >1.- La rúbrica actual es predeterminada, para poder cambiarlo debe presionar el botón de Cambiar rúbrica, seleccionas la rúbrica. </ol>
                                                        <ol >2.- Si quedaste en la mitad de la creación de la rúbrica y accidentalmente se cierra la página, el pc donde te encuentres recordara solamente lo importante. </ol>
                                                    </ul>
                                                    <br/>
                                                    <p>Ahora para seguir, seleccione Guardar o si desea cambiar la rúbrica vaya a Cambiar rúbrica.</p>
                                                    <button id="buttonSeguro" class="btn btn-primary">Cambiar rúbrica</button>
                                                </div>
                                            </div>
                                            <p class="lead text-center">Recuerda guardar tu unidad antes de irte.</p>
                                        ...
                                        <ul class="pager wizard">
                                                ...
                                                <li class="finish" style="float:right;"><a href="javascript:;">Guardar</a></li>
                                        </ul>
                                    </div>
                                </div>
                        </section>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <h3 class="modal-title" id="myModalLabel">¿Estás seguro?</h3>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                    <a href="Biblioteca.php" type="submit" class="btn btn-primary">Si</a>
                </div>
            </div>
             <!--/.modal-content--> 
        </div>
    ...
    $(document).ready(function() {
		...
		window.prettyPrint && prettyPrint()
            ...
            $('#pills .finish').click(function() {
                ...
                <?php else:?>
                <?php if(isset($_COOKIE["recursosdidacticos"]) || isset($_SESSION["Ayuda"]) || isset($_SESSION["preguntas"])): ?>
                    document.getElementById("finalform").submit();
                <?php else: ?>
                    alert('No has hecho niun cambio.');
                    document.getElementById("finalform").submit();
                <?php endif; ?>
                <?php endif;?>
