          ...
          <div class="container">
            <div class="navbar-header">
              <button type="button" class="navbar-toggle collapsed" id="menu-toggle" href="#menu-toggle" aria-expanded="false" aria-controls="navbar">
                ...
                <h4 class="navbar-text navbar-right pull-right titulolandscape" style="margin-top: 30px; margin-right: 80px">Investiga y Aprende</h4>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <h2 class="navbar-text navbar-right" style="margin-top: 50px; margin-right: 80px">Investiga y Aprende</h2>  
            </div><!--/.nav-collapse -->
          </div>
        </nav>
            ...
            <div class="container-fluid separate-rows tall-rows">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                        <p class="lead">Construye una Actividad Heurística en Tres Simples Pasos</p>
                        <div class="row">
...
<!--                                        <p>Crea una nueva unidad de aprendizaje con diagramas heurísticos, recursos didácticos y diversos tipos de evaluaciones.</p>-->
                            ...
                            <div class="col-xs-4 col-md-4 col-lg-4">
                                <div class="row">
                                    <div class="col-xs-12 col-md-12 col-lg-12 text-center">
                                        <a href="cursos.php"><p><img src="img/folder.png" class="img-circle hidden-sm hidden-md hidden-lg" alt="lista" width="80" height="80"><img src="img/folder.png" class="img-circle hidden-xs hidden-lg" alt="lista" width="160" height="160"><img src="img/folder.png" class="img-circle hidden-xs hidden-sm hidden-md" alt="lista" width="180" height="180"></p>Paso 2:<br> Crear curso o Sección</a>
<!--                                        <p>Revisa las actividades y rúbricas ya creadas para compartilas con tus alumnos</p>-->
                            ...
                            <div class="col-xs-4 col-md-4 col-lg-4">
                                <div class="row">
                                    <div class="col-xs-12 col-md-12 col-lg-12 text-center">
                                        <a href="Biblioteca.php"><p><img src="img/biblioteca.png" alt="lista" class="img-circle hidden-sm hidden-md hidden-lg" width="80" height="80"><img src="img/biblioteca.png" alt="lista" class="img-circle hidden-xs hidden-lg" width="160" height="160"><img src="img/biblioteca.png" alt="lista" class="img-circle hidden-xs hidden-sm hidden-md" width="180" height="180"></p>Paso 3:<br> Publicar desde la Biblioteca</a>
                            ...
                            <div class="hidden-xs hidden-sm col-md-6 col-lg-6 text-center">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                                        <div class="text-center">
                                            <br/>
                                             <a href="php/actividades.php"><p><img src="img/lista.png"  alt="folder" width="160" height="160"/></p>Evaluar</a>
                            ...
                            <div class="hidden-xs hidden-sm col-md-6 col-lg-6 text-center">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                                        <div class="text-center">
                                            <br/>
                                            <a data-toggle="modal" data-target="#myModal" href="#"><p><img src="img/mail.png" alt="mail" class="img-circle" width="160" height="160"/></p>Invitar Alumno</a>
                            ...
                            <div class="hidden-md hidden-lg col-xs-6 col-sm-6 text-center">
                                <div class="row">
                                    <div class="col-xs-12 text-center">
                                        <div class="text-center">
                                            <br/>
                                            <a href="php/actividades.php"><p><img src="img/lista.png" alt="folder" width="80" height="80"/></p>Evaluar</a>
<!--                                            <p class="lead">Administración de Cursos o Secciones.</p>-->
                                        </div>
                                    </div> 
                                </div>
                            ...
                            <div class="hidden-md hidden-lg col-xs-6 col-sm-6 text-center">
                                <div class="row">
                                    <div class="col-xs-12 text-center">
                                        <div class="text-center">
                                            <br/>
                                            <a data-toggle="modal" data-target="#myModal" href="#"><p><img src="img/mail.png" alt="mail" class="img-circle" width="80" height="80"/></p>Invitar Alumno</a>
<!--                                            <p class="lead">Invita a tus estudiantes por correo electrónico y forma distintos cursos o secciones.</p>-->
