    ...
    if($_GET["user"]==1){
        ...
        if(isset($_GET["action"])){
            if($_GET["action"]==1){
                ...
                //creacion usuario en Inicio...
                $nombre = "";
                $password = "";
                $correo = "";
                $admin = "";

                if(isset($_POST["nombre"]) && isset($_POST["email1"]) && isset($_POST["password"]))
                {
                    $nombre = $_POST["nombre"];
                    $correo = $_POST["email1"];
                    ...
                    try
                    {
                        ...
                        if(!$docente->Existeono())
                        {
                            if($docente->Ingresar())
                            {
                                ...
                                //no existe y se crea.
                                header("location: ../inicio.php?exito4=1");
                                die();
                            }
                        }
                        else 
                        {
                            //existe
                            header("location: ../inicio.php?error4=1");
                            die();
                        }
