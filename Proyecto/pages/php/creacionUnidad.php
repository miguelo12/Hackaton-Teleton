...
if(!isset($_SESSION["editar"])){
    ...
    else
    {
        ...
        elseif ($new2 ==1) 
        {
            ...
            header("location: ../indexDocente.php?creado=1");
            die();
        ...
        elseif ($new2 ==2) 
        {
            ...
            //Esto se puede mejorar, por falta de tiempo... y paga mejor lo hice de esta manera que antes se hacia de otra manera.
    ...
    if(isset($_GET["action"])){
        if($_GET["action"]==0){
            ...
            $newPreguntas = $_SESSION["preguntas"];
              ...
              unset($_SESSION["NuevaUnidad"]);
              unset($_SESSION["preguntas"]);
              header("location: ../indexDocente.php?editado=1");
              die();
