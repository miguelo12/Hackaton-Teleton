...
class Actividad {
    ...
    public function DevolverActividadAunSinFinalizar()
    {
      $c=$this->con->getConexion();
      
      $sentencia=$c->prepare("SELECT c.Nombre as nombre,b.Codigo as codigo,d.Titulo as titulo,a.fecha_inicio as fechainicio,a.fecha_termino as fechatermino,a.finalizada,a.evaluado,a.idActividad as id from actividad as a INNER JOIN seccion as b ON a.Seccion_idSeccion=b.idSeccion INNER JOIN asignatura as c ON b.Asignatura_idAsignatura=c.idAsignatura INNER JOIN unidadaprendizaje as d on a.UnidadAprendizaje_idUnidadAprendizaje=d.idUnidadAprendizaje where (fecha_termino>=CURDATE() and finalizada=0) and a.idActividad=?");
