...
class Alumno {
    ...
    public function validar()
    {
      ...
      if($resu -> num_rows > 0)
      {
          while($row = $resu->fetch_assoc()){
              $res = array("id" => $row["idAlumno"], "nombre" => $row["nombre"], "email" => $row["email"], "habilitado" => $row["habilitado"], "anonimo" => $row["anonimo"]);
          }
      }
      else {
          unset($res);
    ...
    public function validarAnonimo()
    {
      $c=$this->con->getConexion();
    ...
    public function Ingresar()
    {
      ...
      $sentencia->bind_param("ssssii", $this->idAlumno, $this->email, $this->password, $this->nombre, $this->habilitado, $this->anonimo);
    ...
    public function Actualizar()
    {
      ...
      $sentencia=$c->prepare("update alumno set email=?, nombre=?, password=?, habilitado=? , anonimo=? where idAlumno=? and nombre='Sin nombre' and anonimo=1");
      
      $sentencia->bind_param("sssiis", $this->email, $this->nombre, $this->password, $this->habilitado, $this->anonimo, $this->idAlumno);
